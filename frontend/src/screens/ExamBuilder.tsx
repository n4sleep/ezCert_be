  ...
  return (
    <div className="flex h-[calc(100vh-5rem)]">
      ...
      <aside className="hidden md:flex flex-col w-1/4 max-w-sm bg-surface-container-lowest border-r border-outline-variant/30 h-full shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        <div className="p-lg">
          <button className="w-full flex items-center justify-center gap-sm bg-primary text-on-primary font-label-md py-md rounded-xl hover:bg-primary-container transition-all shadow-[0_4px_12px_rgba(53,37,205,0.2)] hover:-translate-y-0.5">
        ...
        <div className="flex-1 overflow-y-auto px-lg pb-lg space-y-sm">
          ...
          {feed
            ...
            .map((i) => (
              <div key={i.id} className="block p-md rounded-xl bg-surface hover:bg-surface-container transition-colors">
      ...
      <div className="flex-1 flex flex-col bg-surface relative">
        ...
        <div className="flex-1 overflow-y-auto px-md md:px-xxl py-xl space-y-xl z-10 pb-32">
          {feed.length === 0 && (
        ...
        <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-surface via-surface/90 to-transparent pt-xl pb-lg px-md md:px-xxl z-20">
          <div className="max-w-4xl mx-auto">
            <div className="relative bg-surface-container-lowest rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-outline-variant/30 flex items-center p-2 focus-within:ring-2 focus-within:ring-primary/50">
              ...
              />
              <button
                className="w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center hover:scale-105 transition-all shadow-md"
                onClick={submit}
